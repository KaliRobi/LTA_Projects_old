...
from flaskr.lta_database import get_dt_db
from flaskr.ltausers import user_session, login_needed, logoff
from flaskr.db_queries import row_counter, record_counter, current_user_records, edit_pull_record, edit_one_record, update_one_record
...
#EDIT RECORS EDIT RECORDS  EDIT RECORS EDIT RECORDS  EDIT RECORS EDIT RECORDS  EDIT RECORS EDIT RECORDS  EDIT RECORS EDIT RECORDS  EDIT RECORS EDIT RECORDS  EDIT RECORS EDIT RECORDS  EDIT RECORS EDIT RECORDS  
        ...
        for i in modified_record:
            if i == None:
                error = "You cant submit None value"
                flash(error)


        update_one_record(modified_record)
